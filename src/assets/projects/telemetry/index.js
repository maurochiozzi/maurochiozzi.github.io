export const telemetry = {
  ...
  text: [
    ...
    "Unfortunately, the flex layout was not a key feature. For each purpose, for each requirement, the layout needed to be hardcode changed, and besides being used for two different purposes (Baja and Aero) in many different competitions (local, regional, national, international), the rigid layout was shown to be a pain in the neck in every single upgrade. By this, after almost 4 years of usage and despite being developed using Java Swing, this application became obsolete, and it will be replaced by other application using modern technologies (maybe Seriouslogger, let see how it goes).",
  ],
  source: "",
